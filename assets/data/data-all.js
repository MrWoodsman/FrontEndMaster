...
<pre class="code_box"><code class="language-css">p {
    ...
    text-align: center;
        ...
        {
            "id": 4,
            "title":"Formatowanie elementów blokowych za pomocą CSS",
            "description":"Ta lekcja pokaże, jak używać CSS do formatowania elementów blokowych, takich jak nagłówki, akapity, listy itp.",
            "lesson":{
                "content":""
            }
        },
        {
            "id": 5,
            "title":"Tworzenie layoutów za pomocą CSS",
            "description":"Ta lekcja pokaże, jak używać CSS do tworzenia layoutów strony, takich jak układ kolumn czy układ responsywny.",
            "lesson":{
                "content":""
            }
        },
        {
            "id": 6,
            "title":"Efekty CSS",
            "description":"Ta lekcja pokaże, jak używać różnych efektów CSS, takich jak cienie, gradienty, transformacje itp., aby nadać stronie bardziej atrakcyjny wygląd.",
            "lesson":{
                "content":""
            }
        },
        {
            "id": 7,
            "title": "Tworzenie animacji za pomocą CSS",
            "description": "Ta lekcja pokaże, jak używać CSS do tworzenia animacji na stronie.",
            "lesson": {
                "content": ""
            }
        },
        {
            "id": 8,
            "title": "Używanie selektorów CSS",
            "description": "Ta lekcja pokaże, jak używać różnych selektorów CSS do precyzyjnego dobierania elementów HTML do formatowania.",
            "lesson": {
                "content": ""
            }
        },
        {
            "id": 9,
            "title": "Tworzenie stylów dla różnych urządzeń",
            "description": "Ta lekcja pokaże, jak używać CSS do tworzenia stylów dostosowanych do różnych rozmiarów ekranów i urządzeń.",
            "lesson": {
                "content": ""
            }
        },
        {
            "id": 10,
            "title": "Używanie predefiniowanych stylów CSS",
            "description": "Ta lekcja pokaże, jak korzystać z predefiniowanych stylów CSS, takich jak Bootstrap czy Foundation, do szybszego tworzenia stron internetowych.",
            "lesson": {
                "content": ""
            }
        }
